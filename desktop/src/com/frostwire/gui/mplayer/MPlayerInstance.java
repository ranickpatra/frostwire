...
public class MPlayerInstance {
    ...
    public static void initialise(File binary_path) {
    ...
    private Semaphore stop_sem = new Semaphore(1);

    private boolean paused;

    private List<String> commands = new LinkedList<String>();
    private Semaphore command_sem = new Semaphore(1);
                        ...
                        try {
                            while (true) {
                                ...
                                if (toBeSent.startsWith("sleep ") || toBeSent.startsWith("pausing_keep_force sleep ")) {
                                    ...
                                    seekingSendTime = getMonotonousTime();
                                }
    ...
    updateObservedPaused(
        ...
        synchronized (this) {
            ...
            pause_reported_time = getMonotonousTime();
        }
    }
    ...
    private static long getMonotonousTime() {
